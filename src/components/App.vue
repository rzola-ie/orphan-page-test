    ...
    export default {
        ...
        methods: {
            activateSim() {
                ...
                this.iFrame.setAttribute('allowusermedia', "true")
...
#simulator .content .content-container::before {
  content: '';
  position: absolute;
  width: 10px;
  left: 0;
...
#simulator .button-container button span::after {
  position: absolute;
  content: '';
  top: 4px;
  bottom: 0;
...
#next-steps .buttons button {
    ...
    font-family: "Oswald", sans-serif;
    font-size: 1.2em;
    background: linear-gradient(30deg, hsl(78, 27%, 17%), 60%, #87896F);
    color: white;
    border: none
}
